...
public class MovimientoConVuelo implements EstrategiaDeMovimiento {
    @Override
    ...
    private boolean esMovimientoValido(Pieza pieza, Coordenada2D coordenadaInicial, Coordenada2D coordenadaFinal, Casillero casilleroFinal, Coordenada2D diferencias, TableroCuadrado tablero) {
        ...
        // Verificar que el camino esté despejado (con el poder de vuelo se puede pasar sobre otras piezas)
        return (esMovimientoNormal || esCaptura);
    }
